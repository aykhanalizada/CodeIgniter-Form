                ...
                <div class="card shadow-lg">
                    <div class="card-body p-5">
                        ...
                        <div class="mb-3">
                            ...
                            <?= form_input(['type' => 'text', 'name' => 'name', 'required' => 'required', 'class' => 'form-control']); ?>
                        </div>

                        <div class="mb-3">
                            <label class="mb-2 text-muted" for="name">Last Name</label>
                            <?= form_input(['type' => 'text', 'name' => 'surname', 'required' => 'required', 'class' => 'form-control']); ?>
                        </div>

                        <div class="mb-3">

                            <label class="mb-2 text-muted" for="password">Birthday</label>
                            <?= form_input(['type' => 'date', 'name' => 'birthday', 'class' => 'form-control', 'id' => 'birthday']); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <?= form_password(['name' => 'confirm_password', 'required' => 'required', 'class' => 'form-control', 'id' => 'confirm_password']); ?>
                    ...
                    <div class="card-footer py-3 border-0">
                        <div class="text-center">
                            Have an account ? <a href="<?= site_url('/') ?>" class="text-dark"> Login</a>
                        </div>
                    </div>
                </div>
